              ...
              <section>
                ...
                <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea className="w-full bg-[#1c1b1c] border border-[#4d4635] rounded-lg p-4 focus:ring-1 focus:ring-[#84cc16] focus:border-[#84cc16] text-[#e5e2e3] placeholder-[#d0c5af]/50 outline-none transition-shadow" 
                      placeholder="Apartment, suite, or unit number" rows={3}></textarea>
                  </div>
                  <div className="md:col-span-2">
