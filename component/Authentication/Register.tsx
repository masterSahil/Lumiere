    ...
    <>
      <div className="bg-[var(--color-dark-bg)] text-white overflow-x-hidden min-h-screen dark">
        ...
        <main className="relative min-h-screen grid grid-cols-1 md:grid-cols-12 overflow-hidden z-10">
          ...
          <section className="hidden md:flex md:col-span-7 lg:col-span-8 relative items-center justify-center p-16 overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-2xl">
              <h2 className="text-[64px] leading-[1.1] tracking-[-0.02em] font-bold text-white mb-6">
                Begin your <span className="font-serif text-[var(--color-primary-400)]">culinary</span> journey.
              </h2>
          ...
          {/* Registration Panel */}
          <section className="col-span-1 md:col-span-5 lg:col-span-4 flex flex-col items-center justify-center p-5 md:p-16 bg-[var(--color-dark-surface)] relative z-10 border-l border-white/5 md:py-24">
            ...
            <div className="w-full max-w-md space-y-8">
              ...
              <form className="space-y-5" onSubmit={Register}>
                ...
                <button className="w-full py-4 bg-[var(--color-primary-500)] text-[var(--color-dark-bg)] text-[12px] leading-none tracking-widest uppercase rounded-lg font-bold hover:bg-[var(--color-primary-400)] transition-all duration-300 shadow-[0_0_20px_rgba(132,204,22,0.2)] active:scale-95" 
                  type="submit">
                  Create Account
                </button>
              </form>
              ...
              <p className="text-center text-sm text-gray-400">
                ...
                <Link className="text-[var(--color-primary-400)] font-semibold hover:underline" href="/login">Sign In</Link>
              </p>
            </div>
