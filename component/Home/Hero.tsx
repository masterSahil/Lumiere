...
export default function Hero() {
  return (
    <div className="relative h-screen flex items-center justify-center">
      ...
      >
        <div className="absolute inset-0 bg-slate-900/60 bg-gradient-to-t from-slate-900/90 to-transparent"></div>
      </div>
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto mt-20">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold text-white mb-6 leading-tight drop-shadow-lg">
          Elevate Your <br/> <span className="text-amber-400 text-transparent bg-clip-text bg-gradient-to-r from-amber-200 to-amber-500">Culinary Senses</span>
        </h1>
