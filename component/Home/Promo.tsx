    ...
    <section className="py-24 px-5 md:px-20 bg-[#131314]">
      <div className="max-w-360 mx-auto relative glass-card p-12 md:p-20 overflow-hidden text-center gold-glow rounded-3xl">
        ...
        <div className="relative z-10">
          <h3 className="font-sans text-[14px] leading-5 tracking-wider font-semibold text-primary-400 uppercase mb-4">Limited Availability</h3>
          ...
          <button className="bg-primary-400 text-dark-bg px-12 py-5 rounded-full font-sans text-[14px] leading-5 tracking-wider font-semibold hover:scale-105 transition-all">
