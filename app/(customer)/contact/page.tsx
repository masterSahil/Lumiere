      ...
      <main className="pt-20">
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <motion.div variants={fadeInUp} className="lg:col-span-8 bg-dark-surface p-10 rounded-xl border border-white/5 shadow-xl hover:border-white/10 transition-colors">
              <div className="flex items-center gap-3 mb-8">
                <span className="material-symbols-outlined text-primary-500" style={{ fontVariationSettings: "'FILL' 1" }}>calendar_month</span>
              ...
              <form className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <select className="w-full bg-dark-bg border border-white/10 text-white rounded-lg py-4 px-4 appearance-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500 outline-none">
                ...
                <div className="space-y-2">
                  ...
                  <input 
                    className="w-full bg-dark-bg border border-white/10 text-white rounded-lg py-4 px-4 focus:ring-1 focus:ring-primary-500 focus:border-primary-500 outline-none" 
                    type="date" 
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <button className="py-2 border border-primary-500 text-primary-500 rounded-lg text-sm hover:bg-primary-500/10 transition-colors" type="button">18:30</button>
                    <button className="py-2 border border-white/10 text-gray-400 rounded-lg text-sm hover:border-primary-500 hover:text-primary-500 transition-colors" type="button">20:00</button>
                    <button className="py-2 border border-white/10 text-gray-400 rounded-lg text-sm hover:border-primary-500 hover:text-primary-500 transition-colors" type="button">21:30</button>
                  </div>
                </div>
                ...
                <div className="md:col-span-2 pt-4">
                  <button className="w-full bg-primary-500 text-dark-bg font-sans text-[12px] leading-none tracking-widest font-semibold uppercase py-5 rounded-lg hover:bg-primary-400 transition-all shadow-[0_0_20px_rgba(132,204,22,0.2)]">
            ...
            <div className="lg:col-span-4 flex flex-col gap-6">
              ...
              {/* Location/Hours */}
              <motion.div variants={fadeInUp} className="bg-dark-surface border border-white/5 p-8 rounded-xl flex-1 shadow-xl hover:border-white/10 transition-colors">
                <h3 className="font-serif text-2xl font-semibold mb-6 text-primary-400">Hours of Service</h3>
                ...
                <div className="mt-8 space-y-4">
                  <div className="flex items-center gap-4 group">
                    <span className="material-symbols-outlined text-primary-500 group-hover:scale-110 transition-transform">location_on</span>
                    <span className="font-sans text-sm text-white">127 Luminance Blvd, Arts District</span>
                  </div>
                  <div className="flex items-center gap-4 group">
                    <span className="material-symbols-outlined text-primary-500 group-hover:scale-110 transition-transform">call</span>
                    <span className="font-sans text-sm text-white">+1 (555) 800-LUMI</span>
                  </div>
                  <div className="flex items-center gap-4 group">
                    <span className="material-symbols-outlined text-primary-500 group-hover:scale-110 transition-transform">mail</span>
              ...
              {/* Social Bento */}
              <motion.div variants={fadeInUp} className="bg-dark-surface border border-white/5 p-8 rounded-xl flex flex-col items-center justify-center gap-4 shadow-xl hover:border-white/10 transition-colors">
                <p className="font-sans text-[12px] leading-none tracking-widest font-semibold text-gray-400 uppercase">Follow the Glow</p>
                <div className="flex gap-6">
                  <a className="text-white hover:text-primary-400 hover:-translate-y-1 transition-all" href="#">
                    Instagram
                  </a>
                  <a className="text-white hover:text-primary-400 hover:-translate-y-1 transition-all" href="#">
                    Twitter
          ...
          <div className="max-w-3xl mx-auto">
            <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input 
                  className="w-full bg-dark-surface border border-white/5 text-white rounded-lg py-3 px-4 focus:border-primary-500 outline-none" 
                  type="text" 
                />
              </div>
              <div className="space-y-2">
              ...
              <div className="md:col-span-2 space-y-2">
                ...
                <textarea 
                  className="w-full bg-dark-surface border border-white/5 text-white rounded-lg py-3 px-4 focus:border-primary-500 outline-none resize-none" 
                  rows={4}
                ></textarea>
              </div>
              <div className="md:col-span-2 mt-4 text-center">
                <button className="bg-dark-bg text-primary-500 border border-primary-500 font-sans text-[12px] leading-none tracking-widest font-semibold uppercase px-10 py-4 rounded-full hover:bg-primary-500 hover:text-dark-bg transition-all mx-auto inline-block">
                  Send Inquiry
                </button>
              </div>
            </form>
