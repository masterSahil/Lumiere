      ...
      <main className="pt-20">
        ...
        <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-5">
            <h1 className="font-serif text-[40px] md:text-[64px] leading-[1.2] md:leading-[1.1] tracking-[-0.02em] font-bold mb-4 text-glow text-white">
              Join Us at the Table
            </h1>
            <p className="font-sans text-[18px] leading-[1.6] text-gray-300 max-w-2xl mx-auto">
        ...
        <section className="px-5 md:px-16 py-30 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8 bg-[var(--color-dark-surface)] p-10 rounded-xl border border-white/5 shadow-xl">
            ...
            <div className="lg:col-span-4 flex flex-col gap-6">
              ...
              {/* Location/Hours */}
              <div className="bg-[var(--color-dark-surface)] border border-white/5 p-8 rounded-xl flex-1 shadow-xl">
                ...
                <div className="mt-8 space-y-4">
                  <div className="flex items-center gap-4">
                    <span className="material-symbols-outlined text-[var(--color-primary-500)]">location_on</span>
                    <span className="font-sans text-sm text-white">127 Luminance Blvd, Arts District</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="material-symbols-outlined text-[var(--color-primary-500)]">call</span>
                    <span className="font-sans text-sm text-white">+1 (555) 800-LUMI</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="material-symbols-outlined text-[var(--color-primary-500)]">mail</span>
              ...
              {/* Social Bento */}
              <div className="bg-[var(--color-dark-surface)] border border-white/5 p-8 rounded-xl flex flex-col items-center justify-center gap-4 shadow-xl">
                <p className="font-sans text-[12px] leading-none tracking-widest font-semibold text-gray-400 uppercase">Follow the Glow</p>
                <div className="flex gap-6">
                  <a className="text-white hover:text-[var(--color-primary-400)] transition-colors" href="#">
                    Instagram
                  </a>
                  <a className="text-white hover:text-[var(--color-primary-400)] transition-colors" href="#">
                    Twitter
