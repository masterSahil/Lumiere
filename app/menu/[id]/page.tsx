      ...
      <main className="px-5 md:px-20 py-12 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <motion.div 
            ...
            className="md:w-1/2 relative rounded-3xl overflow-hidden border border-[var(--color-primary-900)] shadow-[0_0_30px_rgba(34,197,94,0.1)]"
          >
          ...
          >
            <h4 className="text-[var(--color-primary-400)] text-[14px] font-bold tracking-widest uppercase mb-4">{food.category?.name || 'Signature'}</h4>
            ...
            <div className="flex flex-wrap gap-3 mb-10">
              {food.attributes?.map((attr: string, i: number) => (
                <span key={i} className="bg-[var(--color-dark-surface)] border border-[var(--color-primary-800)] text-[var(--color-primary-200)] text-[12px] font-bold px-4 py-2 rounded-full uppercase tracking-wider">
                  {attr}
                </span>
              ))}
            </div>
