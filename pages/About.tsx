  ...
  return (
    <>
      ...
      <div className="min-h-screen selection:bg-[#84cc16] selection:text-[#062100]">
        ...
        {/* Footer */}
        <footer className="border-t border-[#4d4635]/30 py-16 text-center bg-[#131314]">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-3xl font-serif font-bold text-[#84cc16] mb-8">Lumière</h2>
            <div className="flex justify-center gap-8 mb-12">
              <a href="#" className="text-[#d0c5af] hover:text-[#84cc16] transition-colors"><span className="material-symbols-outlined">camera_alt</span></a>
              <a href="#" className="text-[#d0c5af] hover:text-[#84cc16] transition-colors"><span className="material-symbols-outlined">mail</span></a>
